...
to setup
  ...
  create-wheelchairs 1 [
    set size 1
    set color gray
    set AWwheel 51.65 + 154.8 ; place holder - maximim fraction of hand times maximum hand SA
  ...
  ask patients[
    ...
    set contamCdiff contamconc * AH / AH ; 1-6 spores per hand
    ...
    set contamMRSA contamconc * AH / AH
...
<experiments>
  <experiment name="experiment" repetitions="1000" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="contamconc">
      <value value="1"/>
      <value value="10"/>
      <value value="100"/>
    </enumeratedValueSet>
