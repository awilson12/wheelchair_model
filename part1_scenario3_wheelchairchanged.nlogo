...
;wheelchairs-own [contamCdiff1 contamCdiff2 contamMRSA1 contamMRSA2 AWhandle AWwheel contamCdifftemp contamMRSAtemp]
...
to clean
  if cleaning = true[
    ask one-of wheelchairs-here [
      ;cleaning MRSA
      let cleanprob random-float 1
      ifelse cleanprob >= 0.5
      [
      ...
      ;cleaning C diff
      set contamCdiff2 contamCdiff2
        set contamCdiff1 contamCdiff1]]]
end
